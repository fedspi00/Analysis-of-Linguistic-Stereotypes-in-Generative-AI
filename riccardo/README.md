...
# AI Bias Forensic Analysis Framework

Questo framework analizza le "ombre" nei Large Language Models, investigando come l'identità etnica e le varianti linguistiche influenzino le decisioni automatizzate nel reclutamento.
